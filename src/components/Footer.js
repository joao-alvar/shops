        ...
        <div class="footer__links">
          <div class="footer__col__1">
            ...
            <ul>
              ...
              <li>
                <Link to="/">garantia marketplace</Link>
              </li>
              <li>
                <Link to="/">como é trabalhar conosco</Link>
              </li>
            </ul>
          </div>
          <div class="footer__col__2">
            <span>
              <h2>ajuda &#x26; informação</h2>
            </span>
            <ul>
              <li>
              ...
              <li>
                <Link to="/">politica de copyright</Link>
              </li>
            </ul>
          </div>
          <div class="footer__col__3">
            ...
            <ul>
              <li>
                <Link to="/">abra uma boutique</Link>
              </li>
              <li>
                <Link to="/">ajuda com vendas</Link>
              </li>
            </ul>
          </div>
        </div>
